    ...
    <main>
        ...
        <div className="container hero-grid">
          ...
          >
            ...
            <p className="hero-description">
              Nexus Test Labs Pvt. Ltd. provides professional environmental,
              food, water and workplace testing services, with dedicated client
              support for Hyderabad, Telangana and Andhra Pradesh.
            </p>
          ...
          >
            ...
            >
              ...
              <div className="card-top">
                <span className="mini-label">Testing Solutions</span>
              ...
              <p className="card-description">
                Testing and monitoring solutions for organisations across
                multiple industries.
              </p>
              ...
              <div className="hero-card-footer">
                <div>
                  ...
                  <strong>Hyderabad • Telangana • AP</strong>
                </div>
      ...
      <section className="lab-showcase-section">
        <div className="container lab-showcase-grid">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
          >
            <span className="eyebrow">Inside Nexus Test Labs</span>

            <h2>
              Laboratory expertise
              <br />
              <span className="heading-highlight">you can see.</span>
            </h2>

            <p>
              Behind every test report is a structured laboratory process,
              trained technical team and dedicated testing infrastructure.
            </p>

            <div className="lab-feature-list">
              {[
                ["Water Analysis", Droplets],
                ["Food Testing", Utensils],
                ["Microbiology", Microscope],
                ["Environmental Monitoring", Wind],
              ].map(([title, Icon]: any) => (
                <div key={title}>
                  ...
                  <div>
                    <strong>{title}</strong>
                    <span>
                      Professional laboratory and testing support.
                    </span>
                  </div>
                </div>
              ))}
            ...
            <a href="#contact" className="lab-showcase-button">
        ...
        <div className="container">
          ...
          >
            ...
            <h2>
              ...
              <br />
              <span className="heading-highlight">Your Requirements</span>
            </h2>
          </motion.div>
      ...
      <section id="industries" className="industries-section">
        <div className="container">
          <div className="section-heading">
            ...
            <h2>One Testing Partner. Multiple Industries.</h2>
          </div>
          ...
          <div className="industry-grid">
            {industries.map((industry) => (
              <div className="industry-card" key={industry}>
                ...
                <span>{industry}</span>
                <ArrowRight className="industry-arrow" size={17} />
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="about" className="section about-section">
        <div className="container about-box">
          <div className="about-left">
            ...
            <p>
              Nexus combines laboratory expertise with dedicated regional
              support to help organisations coordinate their testing
          ...
          <div className="about-panel">
            ...
            <p>
              Nexus Test Labs Pvt. Ltd. supports organisations across multiple
              sectors. Our Hyderabad platform extends the same company
              expertise and service standards to clients across Telangana and
              Andhra Pradesh.
            </p>
      ...
      <section id="contact" className="contact-section">
        <div className="container contact-grid">
          <div className="contact-content">
            ...
            <h2>Tell us what you need tested.</h2>

            <p>
              Share your requirement and our regional team will connect with
              you.
            </p>
          </div>
      ...
      <footer className="footer">
        <div className="container footer-bottom">
          <p>© 2026 Nexus Test Labs Pvt. Ltd. All Rights Reserved.</p>
        </div>
      </footer>
